...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // keep resizing so viewInsets updates
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            // Email field (wrapped with a container having a key)
                            Container(
                              key: _emailFieldKey,
                              child: Form(
                                key: emailKey,
                      ...
                      // Fill the remaining space so intrinsic height + minHeight logic keeps footer at bottom
                      const Spacer(),
                    ],
                  ),
                ),
